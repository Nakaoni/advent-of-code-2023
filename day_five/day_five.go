...
import (
	"github.com/Nakaoni/advent-of-code-2023/day_five/part_one"
	"github.com/Nakaoni/advent-of-code-2023/day_five/part_two"
	"github.com/Nakaoni/advent-of-code-2023/utils"
	"log"
)

func main() {
	log.SetPrefix("day_five: ")
	log.SetFlags(0)

	lines, err := utils.GetFileContent("./day_five/assets/input.txt")
	if err != nil {
		log.Panicln(err)
	}
